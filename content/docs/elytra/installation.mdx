...
<Tab value="amd64">
  ```bash
    curl -o /usr/local/bin/elytra https://github.com/pyrohost/elytra/releases/latest/download/elytra_linux_amd64 
  ```
</Tab>
<Tab value="arm64">
  ```bash
    curl -o /usr/local/bin/elytra https://github.com/pyrohost/elytra/releases/latest/download/elytra_linux_arm64 
  ```
</Tab>
</Tabs>
